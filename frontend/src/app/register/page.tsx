...
export default function RegisterPage() {
  ...
  return (
    <div className="flex flex-row-reverse min-h-screen bg-[#0a0a0a]">
      {/* Right: editorial image panel */}
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <img
          src="/products/prod4.jpg"
          alt="Register visual"
          className="absolute inset-0 w-full h-full object-cover opacity-70"
        />
        <div className="absolute inset-0 bg-gradient-to-l from-black/60 to-transparent" />
        <div className="absolute inset-0 flex flex-col justify-end p-16 z-10 text-right">
          <p className="text-white/30 text-xs tracking-[0.5em] uppercase mb-4">Join Us</p>
          <h2 className="text-4xl font-serif text-white mb-4 leading-tight">
            Wear your<br />heritage.
          </h2>
          <p className="text-white/50 font-light max-w-xs ml-auto text-sm leading-relaxed">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-16">
        <div className="max-w-md w-full">
          ...
          <div className="mb-10">
            <p className="text-white/30 text-xs tracking-[0.5em] uppercase mb-3">New Here?</p>
            <h1 className="text-3xl font-serif text-white mb-2">Create Account</h1>
            <p className="text-white/40 font-light text-sm">
              Already have an account?{' '}
              <Link href="/login" className="text-white/80 hover:text-white underline underline-offset-4 transition-colors">
                Sign in
              </Link>
            </p>
          </div>
