      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-6">
            <button className="text-white/80 hover:text-white transition hidden sm:block">
              <Search size={20} strokeWidth={1.5} />
            </button>

            {/* Auth button — shows dropdown when logged in, link to login if not */}
            {user ? (
            ...
            <Link href="/cart" className="text-white/80 hover:text-white transition relative flex items-center">
